...
@section('content')
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class="panel-title"> All Divisions
                        @can('division-create')
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.getall.divisions') !!}',
                columns: [
                    {data: 'rownum', name: 'rownum'},
                    {data: 'division_name', name: 'division_name'},
                    {data: 'division_area', name: 'division_area'},
                    {data: 'division_address', name: 'division_address'},
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('Add New Division'); // Set Title to Bootstrap modal title
